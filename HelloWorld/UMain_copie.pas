...
var
  ...
  // COLONNES : Secondaire | Sup�rieur | ECTS
...
begin
  ...
  begin
    ...
    begin
      // ETCS gestion du cas non pr�sent dans la requ�te (colonne niveau): 3
      nb_niveau := 3;
    end;
  ...
  begin
    ...
    // nb_period : p�riode en cours
    // nb_period_previous : p�riode pr�c�dente
